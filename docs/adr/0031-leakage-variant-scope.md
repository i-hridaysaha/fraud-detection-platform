...
- **(b)** The construction ADR 0020 kept out of `fraud_platform.features`: `groupby` the ADR 0001
  ...
  shipped 186. The page ADR 0020 fetched, read again this session, lists the published set as
...
- (b) is the construction the first-place solution on this dataset rests on, per the page fetched
  and read this session and in stage 4. It is legitimate there because the group's later rows are
